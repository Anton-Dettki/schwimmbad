...
// node_modules/@sx-premium/interactive-event-modal/dist/core.umd.js
var require_core_umd = __commonJS({
  "node_modules/@sx-premium/interactive-event-modal/dist/core.umd.js"(exports, module) {
    (function(global, factory) {
      typeof exports === "object" && typeof module !== "undefined" ? factory(exports, (init_signals_module(), __toCommonJS(signals_module_exports)), (init_jsxRuntime_module(), __toCommonJS(jsxRuntime_module_exports)), (init_hooks_module(), __toCommonJS(hooks_module_exports)), (init_preact_module(), __toCommonJS(preact_module_exports)), (init_compat_module(), __toCommonJS(compat_module_exports))) : typeof define === "function" && define.amd ? define(["exports", "@preact/signals", "preact/jsx-runtime", "preact/hooks", "preact", "preact/compat"], factory) : (global = typeof globalThis !== "undefined" ? globalThis : global || self, factory(global.SXInteractiveEventModal = {}, global.preactSignals, global.jsxRuntime, global.preactHooks, global.preact, global.preactCompat));
    })(exports, function(exports2, signals, jsxRuntime, hooks, preact, compat) {
      "use strict";
      const rruleFields = () => {
        return {
          rruleFrequency: {},
      ...
      class CalendarEventImpl {
        ...
        get _isSingleHybridDayTimed() {
          ...
          const endDateMinusOneDay = toDateString$2(new Date(toJSDate$1(endDate).getTime() - 864e5));
      ...
      const createClickOutsideListener = ($app, modalId, withCallback) => {
        return function(e) {
          const modalPlugin = $app.config.plugins.eventModal;
      ...
      const useIconColors = ($app) => {
        ...
        const iconColor = signals.signal($app.calendarState.isDark.value ? ICON_COLOR_DARK_MODE : ICON_COLOR_LIGHT_MODE);
        signals.effect(() => {
      ...
      var ViewLevel;
      (function(ViewLevel2) {
        ViewLevel2["HOURLY"] = "hourly";
        ViewLevel2["DAILY"] = "daily";
      })(ViewLevel || (ViewLevel = {}));
      function EventDisplay({ $app, calendarEvent }) {
        const iconColor = useIconColors($app);
        const modalPlugin = $app.config.plugins.eventModal;
        const isEventEditable = typeof modalPlugin.isEventEditable === "function" ? modalPlugin.isEventEditable(calendarEvent) : true;
        const currentViewIsResource = $app.calendarState.view.value === ViewLevel.HOURLY || $app.calendarState.view.value === ViewLevel.DAILY;
        let resourceColorName = void 0;
        ...
        const openForm = () => {
          ...
          if (calendarEvent.isCopy || "rrule" in calendarEvent._getForeignProperties() && calendarEvent._getForeignProperties().rrule) {
        ...
        const additionalFieldsId = hooks.useState(additionalFields ? randomStringId$2() : void 0)[0];
        hooks.useEffect(() => {
          if (additionalFields) {
      ...
      function TextField({ initialValue, onChange, label, fieldName, id, errorMessage, placeholder }) {
        ...
        return jsxRuntime.jsx(jsxRuntime.Fragment, { children: jsxRuntime.jsxs("div", { class: "sx__form-field", children: [jsxRuntime.jsxs("div", { className: wrapperClasses.join(" "), children: [jsxRuntime.jsx("input", { id, className: "sx__text-field-input", value: inputValue, onInput: (e) => handleInput(e.currentTarget.value), name: fieldName, type: "text", placeholder }), jsxRuntime.jsx("label", { className: "sx__text-field-label", htmlFor: fieldName, children: label })] }), errorMessage && jsxRuntime.jsx("p", { className: "sx__error-message", children: errorMessage })] }) });
      }
      function AppButton({ onClick, children, additionalClasses }) {
        return jsxRuntime.jsx("button", { className: "sx__app-button" + (additionalClasses ? ` ${additionalClasses}` : ""), onClick, children });
      }
      ...
      function Chevron({ direction, onClick, buttonText, disabled = false }) {
        ...
        return jsxRuntime.jsx("button", { type: "button", disabled, className: "sx__chevron-wrapper sx__ripple", onMouseUp: onClick, onKeyDown: handleKeyDown, tabIndex: 0, children: jsxRuntime.jsx("i", { className: `sx__chevron sx__chevron--${direction}`, children: buttonText }) });
      }
      ...
      function MonthViewWeek({ week }) {
        ...
        return jsxRuntime.jsx(jsxRuntime.Fragment, { children: jsxRuntime.jsx("div", { "data-testid": DATE_PICKER_WEEK, className: "sx__date-picker__week", children: weekDays.map((weekDay) => jsxRuntime.jsx("button", { type: "button", tabIndex: hasFocus(weekDay) ? 0 : -1, disabled: !isDateSelectable(weekDay.day), "aria-label": getLocalizedDate($app.datePickerState.datePickerDate.value, $app.config.locale.value), className: weekDay.classes.join(" "), "data-focus": hasFocus(weekDay) ? "true" : void 0, onClick: () => selectDate(weekDay.day), onKeyDown: handleKeyDown, children: weekDay.day.getDate() })) }) });
      }
      function MonthView({ seatYearsView }) {
        ...
        return jsxRuntime.jsx(jsxRuntime.Fragment, { children: jsxRuntime.jsxs("div", { id: elementId, "data-testid": MONTH_VIEW, className: "sx__date-picker__month-view", children: [jsxRuntime.jsx(MonthViewHeader, { setYearsView: seatYearsView }), jsxRuntime.jsx(DayNames, {}), month.map((week) => jsxRuntime.jsx(MonthViewWeek, { week }))] }) });
      }
      ...
      const getScrollableParents$2 = (el, acc = []) => {
        ...
        return getScrollableParents$2(el.assignedSlot ? el.assignedSlot.parentNode : el.parentNode, acc);
      };
      ...
      function AppPopup$1() {
        ...
        return jsxRuntime.jsx(jsxRuntime.Fragment, { children: jsxRuntime.jsx("div", { style: $app.config.teleportTo ? fixedPositionStyle : void 0, "data-testid": "date-picker-popup", className: classList.join(" "), children: datePickerView === DatePickerView.MONTH_DAYS ? jsxRuntime.jsx(MonthView, { seatYearsView: () => setDatePickerView(DatePickerView.YEARS) }) : jsxRuntime.jsx(YearsView, { setMonthView: () => setDatePickerView(DatePickerView.MONTH_DAYS) }) }) });
      }
      ...
      const createDatePickerState = (config, selectedDateParam) => {
        ...
        const inputDisplayedValue = signals.signal(selectedDateParam ? toLocalizedDateString(toJSDate(selectedDateParam), config.locale.value) : "");
        ...
        const handleOnChange = (selectedDate2) => {
          ...
          config.listeners.onChange(selectedDate2);
        };
        signals.effect(() => {
          var _a2;
          if ((_a2 = config.listeners) === null || _a2 === void 0 ? void 0 : _a2.onChange)
            handleOnChange(selectedDate.value);
        });
        return {
          inputWrapperElement: signals.signal(void 0),
          isOpen,
          isDisabled,
          datePickerView,
          selectedDate,
      ...
      const createAppSingleton = (config = {}) => {
        const configInternal = new ConfigBuilder().withFirstDayOfWeek(config.firstDayOfWeek).withLocale(config.locale).withMin(config.min).withMax(config.max).withPlacement(config.placement).withListeners(config.listeners).withStyle(config.style).withTeleportTo(config.teleportTo).withLabel(config.label).withName(config.name).withDisabled(config.disabled).build();
        const timeUnitsImpl = new TimeUnitsBuilder().withConfig(configInternal).build();
        return new DatePickerAppSingletonBuilder().withConfig(configInternal).withDatePickerState(createDatePickerState(configInternal, config.selectedDate)).withTimeUnitsImpl(timeUnitsImpl).withTranslate(translate(configInternal.locale, signals.signal(translations$1))).build();
      };
      ...
      function DatePicker({ initialValue, label, onChange, isDarkMode, name, width, disabled, min, max, locale, placement }) {
        ...
        const [datePicker] = hooks.useState(() => createDatePicker({
          selectedDate: initialValue || toDateString$2(/* @__PURE__ */ new Date()),
      ...
      function Textarea({ initialValue, onChange, label, name, errorMessage, placeholder }) {
        ...
        return jsxRuntime.jsx(jsxRuntime.Fragment, { children: jsxRuntime.jsxs("div", { class: "sx__form-field", children: [jsxRuntime.jsxs("div", { className: wrapperClasses.join(" "), children: [jsxRuntime.jsx("textarea", { className: "sx__textarea-input", value: inputValue, onInput: (e) => handleInput(e.currentTarget.value), id: "last_name", name, placeholder }), jsxRuntime.jsx("label", { className: "sx__textarea-label", htmlFor: name, children: label })] }), errorMessage && jsxRuntime.jsx("p", { className: "sx__error-message", children: errorMessage })] }) });
      }
      ...
      function AppInput() {
        ...
        const openPopup = () => {
          ...
          $app.timePickerState.inputWrapperElement.value = inputWrapperElement instanceof HTMLDivElement ? inputWrapperElement : void 0;
          $app.timePickerState.isOpen.value = true;
        };
      ...
      function TimeInput({ initialValue, onChange, inputRef, nextTabIndexRef, validRange }) {
        ...
        compat.useEffect(() => {
          ...
          if (tabBlocker)
            return;
          if (inputValue.length === 2 && nextTabIndexRef && "current" in nextTabIndexRef) {
      ...
      const getScrollableParents$1 = (el, acc = []) => {
        ...
        return getScrollableParents$1(el.assignedSlot ? el.assignedSlot.parentNode : el.parentNode, acc);
      };
      ...
      function AppPopup() {
        const $app = compat.useContext(AppContext);
        const POPUP_CLASS_NAME2 = "sx__time-picker-popup";
        ...
        const [hoursValue, setHoursValue] = hooks.useState($app.config.is12Hour.value ? getInitialStart12Hour(initialStart) : initialStart);
        const [minutesValue, setMinutesValue] = hooks.useState(initialEnd);
        const clickOutsideListener = (event) => {
          const target = event.target;
          if (![POPUP_CLASS_NAME2, INPUT_WRAPPER_CLASS_NAME].some((className) => target.closest(`.${className}`))) {
        ...
        const getFixedPositionStyles = () => {
          ...
          if (!inputRect)
            return void 0;
          return {
            top: ((_b = $app.config.placement.value) === null || _b === void 0 ? void 0 : _b.includes("bottom")) ? inputRect.height + inputRect.y + 1 : inputRect.y - remSize - popupHeight,
            // subtract remsize to leave room for label text
            left: ((_c = $app.config.placement.value) === null || _c === void 0 ? void 0 : _c.includes("start")) ? inputRect.x : inputRect.x + inputRect.width - popupWidth,
            width: popupWidth,
            position: "fixed"
          };
        };
      ...
      const getTimePickerState = (config, is12HourClock) => {
        ...
        let wasInitialized = false;
        const handleCurrentTimeChanged = (config2, currentTime2) => {
          if (!wasInitialized)
            return wasInitialized = true;
          if (config2.onChange) {
            config2.onChange(currentTime2);
          }
        };
        signals.effect(() => {
      ...
      const createTimePickerAppContext = (config = {}, translateFn) => {
        ...
        return {
          config: {
            onEscapeKeyDown: signals.signal((_a = config.onEscapeKeyDown) !== null && _a !== void 0 ? _a : void 0),
      ...
      function TimePicker({ initialValue, label, name, onChange, placement, isDarkMode, is12Hour, $app }) {
        ...
        const [timePicker] = hooks.useState(createTimePicker({
          ...
          onEscapeKeyDown: ($app2) => {
            window.__sx_escapeKeyDownBlocker__ = true;
            $app2.timePickerState.isOpen.value = false;
            setTimeout(() => {
              window.__sx_escapeKeyDownBlocker__ = false;
            }, 10);
          }
      ...
      function AppCombobox({ items, label, initialSelectedItems, onChange, name, isDarkMode, errorMessage, placeholder }) {
        ...
        const handleInput = (e) => {
          ...
          const filtered = items.filter((item) => {
            return item.toLowerCase().includes(value.toLowerCase()) && !selectedItems.includes(item);
          });
      ...
      function AppComboboxSingleValue({ items, label, initialSelectedItem, onChange, name, isDarkMode, errorMessage, placeholder }) {
        ...
        hooks.useEffect(() => {
          ...
          if (!inputRef.current)
            return;
          inputRef.current.value = ((_a = items.find((i) => i.value === selectedItem)) === null || _a === void 0 ? void 0 : _a.label) || "";
        }, [selectedItem]);
        return jsxRuntime.jsx(jsxRuntime.Fragment, { children: jsxRuntime.jsxs("div", { class: "sx__form-field", children: [jsxRuntime.jsxs("div", { class: "sx__app-combobox-wrapper", id: wrapperId, onClick: toggleOpen, children: [jsxRuntime.jsxs("div", { class: "sx__app-combobox__input-wrapper", children: [jsxRuntime.jsx("input", { ref: inputRef, id: inputId, onInput: handleInput, className: "sx__app-combobox-input", type: "text", placeholder: placeholder || "Search...", name }), jsxRuntime.jsx("label", { className: "sx__app-combobox-label", htmlFor: name, children: label })] }), compat.createPortal(jsxRuntime.jsx("div", { id: listId, class: listClasses, style: {
          top: wrapperRect.y + wrapperRect.height + 1,
          left: wrapperRect.x,
          width: wrapperRect.width
      ...
      function AppSelect({ items, label, initialSelectedItem, onChange, name, isDarkMode, errorMessage }) {
        ...
        return jsxRuntime.jsx(jsxRuntime.Fragment, { children: jsxRuntime.jsxs("div", { class: "sx__form-field", children: [jsxRuntime.jsxs("div", { class: "sx__app-select-wrapper", id: wrapperId, onClick: toggleOpen, children: [jsxRuntime.jsxs("div", { class: "sx__app-select__input-wrapper", children: [jsxRuntime.jsx("input", { ref: inputRef, id: inputId, className: "sx__app-select-input", type: "text", readOnly: true, name }), jsxRuntime.jsx("label", { className: "sx__app-select-label", htmlFor: name, children: label })] }), compat.createPortal(jsxRuntime.jsx("div", { id: listId, class: listClasses, style: {
          top: wrapperRect.y + wrapperRect.height + 1,
          left: wrapperRect.x,
          width: wrapperRect.width
      ...
      const getInitialFrequencyIncludingCustomOption = (modalPlugin, $app) => {
        ...
        const rruleParts = modalPlugin.formValues.value.rrule ? modalPlugin.formValues.value.rrule.split(";") : [];
      ...
      const getInitialRruleUntil = (modalPlugin) => {
        if (modalPlugin.formValues.value.rrule) {
          ...
          return untilPart ? dateStringFromICalendarDateTime(untilPart.split("=")[1]) : "";
        }
      };
      ...
      function EventForm({ $app, removeEditAddedEvent }) {
        ...
        const [startDate, setStartDate] = hooks.useState(modalPlugin.formValues.value.start ? toDateString$2(toJSDate$1(modalPlugin.formValues.value.start)) : "");
        const [startTime, setStartTime] = hooks.useState(modalPlugin.formValues.value.start ? toTimeString$1(toJSDate$1(modalPlugin.formValues.value.start)) : "");
        const [endDate, setEndDate] = hooks.useState(modalPlugin.formValues.value.end ? toDateString$2(toJSDate$1(modalPlugin.formValues.value.end)) : "");
        const [endTime, setEndTime] = hooks.useState(modalPlugin.formValues.value.end ? toTimeString$1(toJSDate$1(modalPlugin.formValues.value.end)) : "");
        ...
        const [rruleEndsType, setRruleEndsType] = hooks.useState(() => {
          var _a2, _b2;
          if ((_a2 = modalPlugin.formValues.value.rrule) === null || _a2 === void 0 ? void 0 : _a2.includes("COUNT"))
            return "count";
          if ((_b2 = modalPlugin.formValues.value.rrule) === null || _b2 === void 0 ? void 0 : _b2.includes("UNTIL"))
            return "until";
          return "never";
        });
        ...
        hooks.useEffect(() => {
          modalPlugin.formValues.value.start = isFullDayEvent ? startDate : startDate + dateTimeSeparator + startTime;
        ...
        hooks.useEffect(() => {
          modalPlugin.formValues.value.end = isFullDayEvent ? endDate : endDate + dateTimeSeparator + endTime;
        ...
        const validate = () => {
          Object.entries({
            ...
            if (!validationResult.isValid && fieldName) {
              modalPlugin.formValidationErrors[fieldName].value = validationResult.message;
            } else {
              modalPlugin.formValidationErrors[fieldName].value = void 0;
            }
          });
        };
        ...
        const updateExistingEvent = () => {
          ...
          const eventId = ((_a2 = modalPlugin.calendarEvent.value) === null || _a2 === void 0 ? void 0 : _a2.id) || "";
          const eventToUpdate = modalPlugin.eventsService.get(eventId);
          if (!eventToUpdate)
            throw new Error("Did not find event with ID " + ((_b2 = modalPlugin.calendarEvent.value) === null || _b2 === void 0 ? void 0 : _b2.id));
          const updatedEvent = {
            ...eventToUpdate,
          ...
          if ((_d2 = (_c2 = updatedEvent._options) === null || _c2 === void 0 ? void 0 : _c2.additionalClasses) === null || _d2 === void 0 ? void 0 : _d2.includes(ADDED_EVENT_CLASS_NAME)) {
            updatedEvent._options.additionalClasses = updatedEvent._options.additionalClasses.filter((className) => className !== ADDED_EVENT_CLASS_NAME);
          }
          modalPlugin.eventsService.update(updatedEvent);
          modalPlugin.close();
          if (modalPlugin.modalState.value === "edit_added") {
            (_f2 = (_e2 = modalPlugin.config).onAddEvent) === null || _f2 === void 0 ? void 0 : _f2.call(_e2, updatedEvent);
          } else {
            (_h2 = (_g2 = $app.config.callbacks) === null || _g2 === void 0 ? void 0 : _g2.onEventUpdate) === null || _h2 === void 0 ? void 0 : _h2.call(_g2, updatedEvent);
          }
        };
        const createNewEvent = () => {
          ...
          if (!modalPlugin.config.onAddEvent)
            return;
          const newEvent = {
            id: ((_a2 = modalPlugin.calendarEvent.value) === null || _a2 === void 0 ? void 0 : _a2.id) || "",
        ...
        const setRrule = () => {
          if (!rruleFreq) {
            modalPlugin.formValues.value.rrule = void 0;
            return;
          }
          ...
          if (customRRuleFreq.includes("WEEKLY") && rruleInterval && rruleInterval !== 1 && (rruleByday === null || rruleByday === void 0 ? void 0 : rruleByday.length)) {
        ...
        const hasConfiguredAllDateTimeFields = hasConfiguredFields && configuredFields.startDate && configuredFields.startTime && configuredFields.endDate && configuredFields.endTime;
        ...
        const showDateTimeFields = isAddMode || isEditAddedMode || !hasConfiguredFields || hasConfiguredAllDateTimeFields;
        const showCalendarField = !hasConfiguredFields || configuredFields.calendarId && Object.entries(((_a = $app.config) === null || _a === void 0 ? void 0 : _a.calendars) || {}).length > 1;
        const showResourceField = !hasConfiguredFields || configuredFields.resourceId;
        const showRruleFields = !hasConfiguredFields || configuredFields && configuredFields.rruleFrequency && configuredFields.rruleUntil && configuredFields.rruleCustomFrequency && configuredFields.rruleInterval && configuredFields.rruleCount && configuredFields.rruleByDay;
        hooks.useEffect(() => {
          var _a2;
          const titleField = document.getElementById(titleFieldId);
          if (titleField) {
            (_a2 = window.getSelection()) === null || _a2 === void 0 ? void 0 : _a2.empty();
            setTimeout(() => {
              titleField.focus();
            }, 10);
          }
        ...
        const checkIsInHiddenCalendar = () => {
          if (!$app.calendarEvents.filterPredicate.value)
            return;
          const isInHiddenCalendar2 = [modalPlugin.formValues.value].filter($app.calendarEvents.filterPredicate.value).length === 0;
          setIsInHiddenCalendar(isInHiddenCalendar2);
        };
        hooks.useEffect(() => {
          checkIsInHiddenCalendar();
        }, []);
        const resources = "resourceViewConfig" in $app ? $app.resourceViewConfig.resources.value : [];
        ...
        return jsxRuntime.jsx(jsxRuntime.Fragment, { children: jsxRuntime.jsxs("div", { className: "sx__event-form", children: [modalPlugin.isEditingRecurringEvent.value && jsxRuntime.jsxs("div", { className: "sx__event-form-alert sx__event-form-recurrence-warning", children: [jsxRuntime.jsx(WarningSign, {}), $app.translate("You are editing the first in a series of recurring events.")] }), isInHiddenCalendar && jsxRuntime.jsxs("div", { className: "sx__event-form-alert sx__event-form-info-box", children: [jsxRuntime.jsx(InfoIcon, {}), $app.translate("This event is in a hidden calendar.")] }), true !== modalPlugin.config.hideTitle && jsxRuntime.jsx(TextField, { id: titleFieldId, initialValue: modalPlugin.formValues.value.title || "", onChange: (value) => {
          var _a2, _b2, _c2;
          (_c2 = (_b2 = (_a2 = modalPlugin.config.fields) === null || _a2 === void 0 ? void 0 : _a2.title) === null || _b2 === void 0 ? void 0 : _b2.onChange) === null || _c2 === void 0 ? void 0 : _c2.call(_b2, value);
          modalPlugin.formValues.value.title = value;
          validateIfShouldValidate();
        }, label: ((_d = (_c = modalPlugin.config.fields) === null || _c === void 0 ? void 0 : _c.title) === null || _d === void 0 ? void 0 : _d.label) || $app.translate("Title"), fieldName: ((_f = (_e = modalPlugin.config.fields) === null || _e === void 0 ? void 0 : _e.title) === null || _f === void 0 ? void 0 : _f.name) || "title", errorMessage: (_g = modalPlugin.formValidationErrors.title) === null || _g === void 0 ? void 0 : _g.value, placeholder: (_j = (_h = modalPlugin.config.fields) === null || _h === void 0 ? void 0 : _h.title) === null || _j === void 0 ? void 0 : _j.placeholder }, modalPlugin.formValues.value), showDateTimeFields && jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [jsxRuntime.jsxs("div", { className: "sx__event-time-input", children: [jsxRuntime.jsxs("div", { class: "sx__date-time-picker sx__date-time-start", children: [jsxRuntime.jsx(DatePicker, { label: ((_l = (_k = modalPlugin.config.fields) === null || _k === void 0 ? void 0 : _k.startDate) === null || _l === void 0 ? void 0 : _l.label) || $app.translate("Start date"), placement: isRtl ? "bottom-end" : "bottom-start", name: ((_o = (_m = modalPlugin.config.fields) === null || _m === void 0 ? void 0 : _m.startDate) === null || _o === void 0 ? void 0 : _o.name) || "start-date", onChange: (newStartDate) => {
          var _a2, _b2, _c2;
          (_c2 = (_b2 = (_a2 = modalPlugin.config.fields) === null || _a2 === void 0 ? void 0 : _a2.startDate) === null || _b2 === void 0 ? void 0 : _b2.onChange) === null || _c2 === void 0 ? void 0 : _c2.call(_b2, newStartDate);
          ...
          var _a2, _b2, _c2;
          (_c2 = (_b2 = (_a2 = modalPlugin.config.fields) === null || _a2 === void 0 ? void 0 : _a2.startTime) === null || _b2 === void 0 ? void 0 : _b2.onChange) === null || _c2 === void 0 ? void 0 : _c2.call(_b2, newStartTime);
          setStartTime(newStartTime);
        }, label: ((_s = (_r = modalPlugin.config.fields) === null || _r === void 0 ? void 0 : _r.startTime) === null || _s === void 0 ? void 0 : _s.label) || $app.translate(""), name: ((_u = (_t = modalPlugin.config.fields) === null || _t === void 0 ? void 0 : _t.startTime) === null || _u === void 0 ? void 0 : _u.name) || "start-time", initialValue: startTime, placement: $app.calendarState.isCalendarSmall.value || isRtl ? "bottom-end" : "bottom-start", isDarkMode: $app.calendarState.isDark.value, is12Hour: modalPlugin.config.has12HourTimeFormat || false })] }), jsxRuntime.jsx("span", { className: "sx__date-time-until", children: "until" }), jsxRuntime.jsxs("div", { class: "sx__date-time-picker sx__date-time-end", children: [jsxRuntime.jsx(DatePicker, { label: ((_w = (_v = modalPlugin.config.fields) === null || _v === void 0 ? void 0 : _v.endDate) === null || _w === void 0 ? void 0 : _w.label) || $app.translate("End date"), placement: isRtl ? "bottom-start" : "bottom-end", name: ((_y = (_x = modalPlugin.config.fields) === null || _x === void 0 ? void 0 : _x.endDate) === null || _y === void 0 ? void 0 : _y.name) || "end-date", onChange: (newEndDate) => {
          var _a2, _b2, _c2;
          (_c2 = (_b2 = (_a2 = modalPlugin.config.fields) === null || _a2 === void 0 ? void 0 : _a2.endDate) === null || _b2 === void 0 ? void 0 : _b2.onChange) === null || _c2 === void 0 ? void 0 : _c2.call(_b2, newEndDate);
          ...
          var _a2, _b2, _c2;
          (_c2 = (_b2 = (_a2 = modalPlugin.config.fields) === null || _a2 === void 0 ? void 0 : _a2.endTime) === null || _b2 === void 0 ? void 0 : _b2.onChange) === null || _c2 === void 0 ? void 0 : _c2.call(_b2, newEndTime);
          setEndTime(newEndTime);
        }, label: ((_2 = (_1 = modalPlugin.config.fields) === null || _1 === void 0 ? void 0 : _1.endTime) === null || _2 === void 0 ? void 0 : _2.label) || $app.translate(""), initialValue: endTime, placement: isRtl ? "bottom-start" : "bottom-end", isDarkMode: $app.calendarState.isDark.value, name: ((_4 = (_3 = modalPlugin.config.fields) === null || _3 === void 0 ? void 0 : _3.endTime) === null || _4 === void 0 ? void 0 : _4.name) || "end-time", is12Hour: modalPlugin.config.has12HourTimeFormat || false })] })] }), jsxRuntime.jsx(AppCheckbox, { label: $app.translate("Full-day event"), initialValue: isFullDayEvent, onChange: (isChecked) => setIsFullDayEvent(isChecked) })] }), showRruleFields && jsxRuntime.jsx(jsxRuntime.Fragment, { children: jsxRuntime.jsxs("div", { className: "sx__rrule-wrapper", children: [jsxRuntime.jsx(AppSelect, { items: getFrequenciesIncludingNoneAndCustom($app), initialSelectedItem: getInitialFrequencyIncludingCustomOption(modalPlugin, $app), label: $app.translate("Frequency"), onChange: (value) => {
          setRruleFreq(value);
        }, name: "rrule", isDarkMode: $app.calendarState.isDark.value }), rruleFreq === "custom" && jsxRuntime.jsxs("section", { className: "sx__custom-rrule", children: ["Repeat every  ", jsxRuntime.jsx("div", { className: "sx__form-field", children: jsxRuntime.jsx("div", { class: "sx__text-field-wrapper", children: jsxRuntime.jsx("input", { className: "sx__number-field-input", value: rruleInterval, type: "number", min: 1, max: 1e6, onChange: (e) => {
          const value = parseInt(e.currentTarget.value);
          setRruleInterval(value);
          setRrule();
        } }) }) }), "   ", jsxRuntime.jsx(AppSelect, { items: rruleInterval === 1 ? getRealRruleFrequenciesSingular($app) : getRealRruleFrequenciesPlural($app), initialSelectedItem: getInitialCustomRRuleFrequency(modalPlugin, $app), label: $app.translate(" "), isDarkMode: $app.calendarState.isDark.value, onChange: (value) => {
          updateByDay(value);
          setCustomRRuleFreq(value);
          setRrule();
        }, name: "rruleFrequency" }, rruleInterval), rruleByday && jsxRuntime.jsx(jsxRuntime.Fragment, { children: jsxRuntime.jsx(WeekdaySelector, { activeDays: rruleByday, onDayClick: handleClickOnRruleWeekdaySelector }) }), jsxRuntime.jsxs("div", { className: "sx__rrule-ends", children: [jsxRuntime.jsx("h3", { children: "Ends" }), jsxRuntime.jsx("span", {}), jsxRuntime.jsxs("div", { className: "sx__radio", children: [jsxRuntime.jsx("input", { className: "sx__radio-input", type: "radio", id: "rrule-never", name: "rrule-ends", value: "never", checked: rruleEndsType === "never", onChange: () => setRruleEndsType("never") }), jsxRuntime.jsx("label", { className: "sx__radio-label", htmlFor: "rrule-never", children: "Never" })] }), jsxRuntime.jsx("span", {}), jsxRuntime.jsxs("div", { className: "sx__radio", children: [jsxRuntime.jsx("input", { className: "sx__radio-input", type: "radio", id: "rrule-count", name: "rrule-ends", value: "count", checked: rruleEndsType === "count", onChange: () => setRruleEndsType("count") }), jsxRuntime.jsx("label", { className: "sx__radio-label", htmlFor: "rrule-count", children: "After" })] }), jsxRuntime.jsxs("div", { children: [jsxRuntime.jsx("div", { className: "sx__form-field", children: jsxRuntime.jsx("div", { class: "sx__text-field-wrapper", children: jsxRuntime.jsx("input", { className: "sx__number-field-input", disabled: rruleEndsType !== "count", type: "number", min: 1, max: 1e6, value: rruleCount, onChange: (e) => {
          const value = parseInt(e.currentTarget.value);
          setRruleCount(value);
          ...
          var _a2, _b2, _c2;
          (_c2 = (_b2 = (_a2 = modalPlugin.config.fields) === null || _a2 === void 0 ? void 0 : _a2.description) === null || _b2 === void 0 ? void 0 : _b2.onChange) === null || _c2 === void 0 ? void 0 : _c2.call(_b2, value);
          modalPlugin.formValues.value.description = value;
          validateIfShouldValidate();
        }, placeholder: (_8 = (_7 = modalPlugin.config.fields) === null || _7 === void 0 ? void 0 : _7.description) === null || _8 === void 0 ? void 0 : _8.placeholder, label: ((_10 = (_9 = modalPlugin.config.fields) === null || _9 === void 0 ? void 0 : _9.description) === null || _10 === void 0 ? void 0 : _10.label) || $app.translate("Description"), name: ((_12 = (_11 = modalPlugin.config.fields) === null || _11 === void 0 ? void 0 : _11.description) === null || _12 === void 0 ? void 0 : _12.name) || "description", errorMessage: (_13 = modalPlugin.formValidationErrors.description) === null || _13 === void 0 ? void 0 : _13.value }, modalPlugin.formValues.value + "description"), modalPlugin.config.availablePeople && jsxRuntime.jsx(AppCombobox, { items: modalPlugin.config.availablePeople, initialSelectedItems: modalPlugin.formValues.value.people, onChange: (value) => {
          var _a2, _b2, _c2;
          (_c2 = (_b2 = (_a2 = modalPlugin.config.fields) === null || _a2 === void 0 ? void 0 : _a2.people) === null || _b2 === void 0 ? void 0 : _b2.onChange) === null || _c2 === void 0 ? void 0 : _c2.call(_b2, value);
          modalPlugin.formValues.value.people = value;
          validateIfShouldValidate();
        }, placeholder: (_15 = (_14 = modalPlugin.config.fields) === null || _14 === void 0 ? void 0 : _14.people) === null || _15 === void 0 ? void 0 : _15.placeholder, label: ((_17 = (_16 = modalPlugin.config.fields) === null || _16 === void 0 ? void 0 : _16.people) === null || _17 === void 0 ? void 0 : _17.label) || $app.translate("People"), name: ((_19 = (_18 = modalPlugin.config.fields) === null || _18 === void 0 ? void 0 : _18.people) === null || _19 === void 0 ? void 0 : _19.name) || "people", isDarkMode: $app.calendarState.isDark.value, errorMessage: (_20 = modalPlugin.formValidationErrors.people) === null || _20 === void 0 ? void 0 : _20.value }, modalPlugin.formValues.value + "people"), showCalendarField && jsxRuntime.jsx(AppComboboxSingleValue, { items: getCalendars(), initialSelectedItem: getSelectedCalendarOrUndefined(), label: ((_22 = (_21 = modalPlugin.config.fields) === null || _21 === void 0 ? void 0 : _21.calendarId) === null || _22 === void 0 ? void 0 : _22.label) || $app.translate("Calendar"), onChange: (value) => {
          var _a2, _b2, _c2;
          (_c2 = (_b2 = (_a2 = modalPlugin.config.fields) === null || _a2 === void 0 ? void 0 : _a2.calendarId) === null || _b2 === void 0 ? void 0 : _b2.onChange) === null || _c2 === void 0 ? void 0 : _c2.call(_b2, value);
          modalPlugin.formValues.value.calendarId = value;
          validateIfShouldValidate();
          checkIsInHiddenCalendar();
        }, placeholder: (_24 = (_23 = modalPlugin.config.fields) === null || _23 === void 0 ? void 0 : _23.calendarId) === null || _24 === void 0 ? void 0 : _24.placeholder, name: ((_26 = (_25 = modalPlugin.config.fields) === null || _25 === void 0 ? void 0 : _25.calendarId) === null || _26 === void 0 ? void 0 : _26.name) || "calendar", isDarkMode: $app.calendarState.isDark.value, errorMessage: (_27 = modalPlugin.formValidationErrors.calendarId) === null || _27 === void 0 ? void 0 : _27.value }, modalPlugin.formValues.value + "calendar"), showResourceField && jsxRuntime.jsx(AppComboboxSingleValue, { items: getResourceItems(), initialSelectedItem: getSelectedResourceOrUndefined(), label: ((_29 = (_28 = modalPlugin.config.fields) === null || _28 === void 0 ? void 0 : _28.resourceId) === null || _29 === void 0 ? void 0 : _29.label) || $app.translate("Resource"), placeholder: (_31 = (_30 = modalPlugin.config.fields) === null || _30 === void 0 ? void 0 : _30.resourceId) === null || _31 === void 0 ? void 0 : _31.placeholder, onChange: (value) => {
          var _a2, _b2, _c2;
          (_c2 = (_b2 = (_a2 = modalPlugin.config.fields) === null || _a2 === void 0 ? void 0 : _a2.resourceId) === null || _b2 === void 0 ? void 0 : _b2.onChange) === null || _c2 === void 0 ? void 0 : _c2.call(_b2, value);
          ...
          return jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [field.value.type === "text" && jsxRuntime.jsx(TextField, { id: fieldName, initialValue: modalPlugin.formValues.value[fieldName] || "", onChange: (value) => {
            var _a3, _b3;
            (_b3 = (_a3 = modalPlugin.config.customFields[fieldName].value).onChange) === null || _b3 === void 0 ? void 0 : _b3.call(_a3, value);
            modalPlugin.formValues.value[fieldName] = value;
            validateIfShouldValidate();
          }, placeholder: field.value.placeholder, label: field.value.label || "", fieldName, errorMessage: (_a2 = modalPlugin.formValidationErrors[fieldName]) === null || _a2 === void 0 ? void 0 : _a2.value }, field.value), field.value.type == "select" && jsxRuntime.jsx(AppSelect, { items: field.value.items || [], label: field.value.label || "", onChange: (value) => {
            var _a3, _b3;
            (_b3 = (_a3 = modalPlugin.config.customFields[fieldName].value).onChange) === null || _b3 === void 0 ? void 0 : _b3.call(_a3, value);
            modalPlugin.formValues.value[fieldName] = value;
            validateIfShouldValidate();
          }, initialSelectedItem: ((_b2 = field.value.items) === null || _b2 === void 0 ? void 0 : _b2.find((item) => {
            return item.value === modalPlugin.formValues.value[fieldName];
          })) || void 0, name: fieldName }, field.value), field.value.type === "textarea" && jsxRuntime.jsx(Textarea, { initialValue: modalPlugin.formValues.value[fieldName] || "", onChange: (value) => {
            var _a3, _b3;
            (_b3 = (_a3 = modalPlugin.config.customFields[fieldName].value).onChange) === null || _b3 === void 0 ? void 0 : _b3.call(_a3, value);
            modalPlugin.formValues.value[fieldName] = value;
            validateIfShouldValidate();
          }, placeholder: field.value.placeholder, label: field.value.label || "", name: fieldName, errorMessage: (_c2 = modalPlugin.formValidationErrors[fieldName]) === null || _c2 === void 0 ? void 0 : _c2.value }, field.value), field.value.type === "combobox" && jsxRuntime.jsx(AppComboboxSingleValue, { items: field.value.items || [], label: field.value.label || "", onChange: (value) => {
            var _a3, _b3;
            (_b3 = (_a3 = modalPlugin.config.customFields[fieldName].value).onChange) === null || _b3 === void 0 ? void 0 : _b3.call(_a3, value);
            modalPlugin.formValues.value[fieldName] = value;
            validateIfShouldValidate();
          }, initialSelectedItem: ((_d2 = field.value.items) === null || _d2 === void 0 ? void 0 : _d2.find((item) => {
            return item.value === modalPlugin.formValues.value[fieldName];
          })) || void 0, placeholder: field.value.placeholder, name: fieldName, errorMessage: (_e2 = modalPlugin.formValidationErrors[fieldName]) === null || _e2 === void 0 ? void 0 : _e2.value }, field.value), field.value.type === "combobox-multi" && jsxRuntime.jsx(AppCombobox, { items: ((_f2 = field.value.items) === null || _f2 === void 0 ? void 0 : _f2.map((item) => item.label || "")) || [], label: field.value.label || "", onChange: (value) => {
            var _a3, _b3;
            const valuesForSelectedLabels = value.map((label) => {
              var _a4, _b4;
              return ((_b4 = (_a4 = field.value.items) === null || _a4 === void 0 ? void 0 : _a4.find((item) => item.label === label)) === null || _b4 === void 0 ? void 0 : _b4.value) || "";
            });
            (_b3 = (_a3 = modalPlugin.config.customFields[fieldName].value).onChange) === null || _b3 === void 0 ? void 0 : _b3.call(_a3, valuesForSelectedLabels);
            modalPlugin.formValues.value[fieldName] = valuesForSelectedLabels;
            validateIfShouldValidate();
          }, initialSelectedItems: ((_g2 = modalPlugin.formValues.value[fieldName]) === null || _g2 === void 0 ? void 0 : _g2.map((value) => {
            var _a3, _b3;
            return ((_b3 = (_a3 = field.value.items) === null || _a3 === void 0 ? void 0 : _a3.find((item) => item.value === value)) === null || _b3 === void 0 ? void 0 : _b3.label) || "";
          })) || [], placeholder: field.value.placeholder, name: fieldName, errorMessage: (_h2 = modalPlugin.formValidationErrors[fieldName]) === null || _h2 === void 0 ? void 0 : _h2.value }, field.value), field.value.type === "any" && field.value.InputComponent && jsxRuntime.jsx(field.value.InputComponent, { initialValue: modalPlugin.formValues.value[fieldName] || "", onChange: (value) => {
            var _a3, _b3;
            (_b3 = (_a3 = modalPlugin.config.customFields[fieldName].value).onChange) === null || _b3 === void 0 ? void 0 : _b3.call(_a3, value);
            modalPlugin.formValues.value[fieldName] = value;
            validateIfShouldValidate();
      ...
      function InteractiveEventModal({ $app }) {
        ...
        const escapeKeyDownListener = (e) => {
          setTimeout(() => {
            if (e.key === "Escape" && !window.__sx_escapeKeyDownBlocker__) {
              modalPlugin.close();
              removeEditAddedEvent();
            }
          });
      ...
      const validateConfig = (config) => {
        ...
        if ((fields === null || fields === void 0 ? void 0 : fields.startDate) || (fields === null || fields === void 0 ? void 0 : fields.endDate) || (fields === null || fields === void 0 ? void 0 : fields.startTime) || (fields === null || fields === void 0 ? void 0 : fields.endTime)) {
          if (!fields.startDate || !fields.endDate || !fields.startTime || !fields.endTime) {
        ...
        if ((fields === null || fields === void 0 ? void 0 : fields.rruleFrequency) || (fields === null || fields === void 0 ? void 0 : fields.rruleInterval) || (fields === null || fields === void 0 ? void 0 : fields.rruleCount) || (fields === null || fields === void 0 ? void 0 : fields.rruleUntil) || (fields === null || fields === void 0 ? void 0 : fields.rruleByDay) || (fields === null || fields === void 0 ? void 0 : fields.rruleCustomFrequency)) {
          if (!fields.rruleFrequency || !fields.rruleInterval || !fields.rruleCount || !fields.rruleUntil || !fields.rruleByDay || !fields.rruleCustomFrequency) {
      ...
      const createInteractiveEventModal = (config) => {
        ...
        const formValues = signals.signal({
          start: toDateTimeString(/* @__PURE__ */ new Date()),
          end: toDateTimeString(/* @__PURE__ */ new Date()),
          title: void 0,
          description: void 0,
          location: void 0,
          people: [],
        ...
        function clickToCreate(start, otherEventProperties = {}) {
          ...
          const observer = new MutationObserver((mutations) => {
            mutations.forEach((mutation) => {
              ...
              const eventElement = target.dataset.eventId === String(eventId) ? target : target.querySelector(`[data-event-id="${eventId}"]`);
              ...
              if (eventElement && eventInternal) {
                ...
                formValues.value = {
                  ...
                  calendarId: eventInternal.calendarId !== SX_INTERNAL_CALENDAR ? eventInternal.calendarId : void 0,
          ...
          const _start = start;
          const end = /^\w{4}-\w{2}-\w{2}$/.test(_start) ? _start : addMinutes(_start, 60);
          const newEvent = {
            id: eventId,
            start: _start,
            end,
        ...
        return definePlugin("eventModal", {
          ...
          formValidationErrors: allFieldsWithValidators.reduce((acc, fieldName) => {
            acc[fieldName] = signals.signal(void 0);
            return acc;
          }, {}),
          modalState,
          ...
          openEventCreationModal: (id, start, otherEventProperties = {}) => {
            ...
            const _start = start || toDateTimeString(/* @__PURE__ */ new Date());
            const newEvent = {
              id,
              start: _start,
          ...
          openForExistingEvent: (id) => {
            var _a;
            const event = _$app === null || _$app === void 0 ? void 0 : _$app.calendarEvents.list.value.find((event2) => event2.id === id);
            if (!event) {
      ...
      const translations = {
        enUS: {
          ...
          "Start time": "",
          // defaults to empty string for stylistic reasons. The layout still makes it clear which field it is.
          "End date": "End date",
          "End time": "",
          // defaults to empty string for stylistic reasons. The layout still makes it clear which field it is.
      ...
      exports2.createInputField = createInputField;
      exports2.createInteractiveEventModal = createInteractiveEventModal;
      exports2.rruleFields = rruleFields;
      exports2.translations = translations;
    });
  }
});
export default require_core_umd();
//# sourceMappingURL=@sx-premium_interactive-event-modal.js.map
