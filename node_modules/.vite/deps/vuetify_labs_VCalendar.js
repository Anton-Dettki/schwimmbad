...
import "./chunk-FXELJJ5E.js";
import {
  useDate
} from "./chunk-63LKJNAQ.js";
import "./chunk-IWRKZBXV.js";
import {
  useLocale
...
import "/Users/anton/Repos/schwimmbadPlanung/node_modules/vuetify/lib/labs/VCalendar/VCalendar.css";

// node_modules/vuetify/lib/labs/VCalendar/VCalendarDay.js
import "/Users/anton/Repos/schwimmbadPlanung/node_modules/vuetify/lib/labs/VCalendar/VCalendarDay.css";

// node_modules/vuetify/lib/labs/VCalendar/VCalendarInterval.js
import "/Users/anton/Repos/schwimmbadPlanung/node_modules/vuetify/lib/labs/VCalendar/VCalendarInterval.css";

// node_modules/vuetify/lib/labs/VCalendar/VCalendarIntervalEvent.js
import "/Users/anton/Repos/schwimmbadPlanung/node_modules/vuetify/lib/labs/VCalendar/VCalendarIntervalEvent.css";
...
var VCalendarIntervalEvent = genericComponent()({
  ...
  setup(props, _ref) {
    ...
    useRender(() => {
      ...
      return createBaseVNode("div", null, [((_a = slots.intervalEvent) == null ? void 0 : _a.call(slots, {
...
var VCalendarInterval = genericComponent()({
  ...
  setup(props, _ref) {
    ...
    useRender(() => {
      var _a, _b, _c, _d, _e;
      return props.dayIndex === 0 ? createBaseVNode("div", {
      ...
      })) ?? (props.index ? props.intervalFormat ? typeof props.intervalFormat === "string" ? adapter.format(interval.value.start, "hours12h") : props.intervalFormat(interval.value) : interval.value.label : "12 AM")]), createBaseVNode("div", {
        "class": "v-calendar-day__row-hairline"
      }, null), createBaseVNode("div", mergeProps({
        ...
        interval: interval.value
      })) ?? createBaseVNode("div", null, [(_c = interval.value.events) == null ? void 0 : _c.map((event) => createVNode(VCalendarIntervalEvent, mergeProps({
        "event": event,
        "interval": interval.value,
        "intervalDivisions": props.intervalDivisions,
        "intervalDuration": props.intervalDuration,
...
var VCalendarDay = genericComponent()({
  ...
  setup(props, _ref) {
    ...
    useRender(() => {
      ...
      }, [!props.hideDayHeader && createBaseVNode("div", mergeProps({
        "key": "calendar-week-name",
        "class": "v-calendar-weekly__head-weekday"
      }, getPrefixedEventHandlers(attrs, ":day", () => props.day)), [adapter.format(props.day.date, "weekdayShort"), createBaseVNode("div", null, [createVNode(VBtn, mergeProps(getPrefixedEventHandlers(attrs, ":date", () => props.day), {
...
import "/Users/anton/Repos/schwimmbadPlanung/node_modules/vuetify/lib/labs/VCalendar/VCalendarHeader.css";
  ...
  setup(props, _ref) {
    ...
    useRender(() => {
      ...
      return createBaseVNode("div", {
        ...
        title: props.title
      })) ?? createBaseVNode("span", null, [props.title])])]);
    });
    return {};
  }
});
...
import "/Users/anton/Repos/schwimmbadPlanung/node_modules/vuetify/lib/labs/VCalendar/VCalendarMonthDay.css";
...
var VCalendarMonthDay = genericComponent()({
  ...
  setup(props, _ref) {
    ...
    useRender(() => {
      ...
      return createBaseVNode("div", mergeProps({
      ...
      }, getPrefixedEventHandlers(attrs, ":day", () => props)), [!((_a = props.day) == null ? void 0 : _a.isHidden) ? createBaseVNode("div", {
        "key": "title",
        ...
        "text": `${props.title}`
      }, getPrefixedEventHandlers(attrs, ":date", () => props)), null)]) : void 0, !((_e = props.day) == null ? void 0 : _e.isHidden) ? createBaseVNode("div", {
        "key": "content",
...
var VCalendar = genericComponent()({
  ...
  setup(props, _ref) {
    ...
    useRender(() => {
      ...
      }, [createBaseVNode("div", null, [!props.hideHeader && (((_a = slots.header) == null ? void 0 : _a.call(slots, {
        title: title.value,
      ...
      }, [props.viewMode === "month" && !props.hideDayHeader && createBaseVNode("div", {
      ...
      }, [!props.hideWeekNumber ? createBaseVNode("div", {
        "key": "weekNumber0",
        "class": "v-calendar-weekly__head-weeknumber"
      }, null) : "", weekDays.value.map((weekday) => createBaseVNode("div", {
        "class": normalizeClass(`v-calendar-weekly__head-weekday${!props.hideWeekNumber ? "-with-weeknumber" : ""}`)
      }, [dayNames[weekday]]))]), props.viewMode === "month" && createBaseVNode("div", {
        "key": "VCalendarMonth",
      ...
      }, [chunkArray(daysInMonth.value, weekDays.value.length).map((week, wi) => [!props.hideWeekNumber ? createBaseVNode("div", mergeProps({
