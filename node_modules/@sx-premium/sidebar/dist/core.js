...
function AppSidebar(props) {
    ...
    const addEventButtonCCID = useState$1(() => randomStringId())[0];
    useEffect$1(() => {
    ...
    return (jsxs(Fragment$2, { children: [jsx("div", { class: "sx__sidebar-inner-wrapper", children: jsxs("div", { class: wrapperClasses.join(' '), children: [typeof addEventButtonCustomComponent !== 'undefined' ? (jsx("div", { "data-ccid": addEventButtonCCID })) : (jsx(AppButton, { onClick: openAddEvent, additionalClasses: 'sx__app-button-filled is-full-width sx__add-event-button', children: props.$app.translate('Add event') })), props.hasCalendarToggles && (jsxs("section", { className: "sx__sidebar-section", children: [jsx("h3", { className: "sx__sidebar-section-heading", children: props.$app.translate('Calendars') }), jsx("ul", { className: "sx__calendar-toggles", children: hasCalendars &&
...
const createSidebarPlugin = (config) => {
    ...
    return definePlugin('sidebar', {
        ...
        selectedPlaceholderEvent: signal(undefined),
        placeholderEvents: signal(config.placeholderEvents || []),
...
export { createSidebarPlugin, translations };
